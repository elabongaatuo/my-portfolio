...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Elabonga Atuo 
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">
          Well hello there, hoping your day is full of variance ! I'm curious Yvonne , happy to help you find patterns in your data and make the most out of it. 
        </p>
